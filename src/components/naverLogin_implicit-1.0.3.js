...
//버튼 종류에 대한 정의
var BUTTON_TYPE = 1;
var BANNER_SMALL_TYPE = 2;
var BANNER_BIG_TYPE = 3;
//버튼 색깔에 대한 정의
var BUTTON_COLOR_WHITE = "white";
var BUTTON_COLOR_GREEN = "green";
var color = ''
var state = ''
 ...
 * @private
 */
	this.init_naver_id_login = function (div)
	{
		var naver_id_login = div;
		...
		var naver_id_login_contents="";
		var naver_id_login_url = this.getNaverIdLoginLink();
		if (this.state==undefined || this.state=="")
		{
			this.state = this.getUniqState();
		}
		var naver_id_popup_option = "";
		if (this.popup)
		{
